...
<div id="siteWrapper">
	...
	<div id="contentWrapper" class="wrapper">
		<dnn:BREADCRUMB ID="dnnBreadcrumb" runat="server" CssClass="breadcrumbLink" RootLevel="0" Separator="&lt;img alt=&quot;Flecha&quot; src=&quot;images/breadcrumb.png&quot;&gt; " />
		<div id="content">
            <div id="leftPane" class="twoColLeftPane" >
                <div id="RightContent" runat="server" class="leftPane2"></div>
		        <div id="contentPane" class="twocontentPane" runat="server"></div>       
            </div>
