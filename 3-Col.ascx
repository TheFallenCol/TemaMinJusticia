...
<fortyfingers:STYLEHELPER ID="SH3" AddToHead="<script src='/Js/dnn.modalpopup.js' type='text/javascript'></script>" runat="server" />
...
<div id="siteWrapper">
	...
	<div id="mainContent" class="containerCols">
		 <div class="columns">                
                <div class="paneGroup">
